...
{% include image.html url="assets/part6/OR.png" %}
...
{% include image.html url="assets/part6/NAND_Construction.png" %}

Similarly, we can construct the XOR gate with the following combination of other logic gates.

{% include image.html url="assets/part6/XOR_Construction.png" %}

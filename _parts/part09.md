...
Next, we can also add further logic to our circuit by implementing the AND and OR logic. The AND  


finish explaining aside
include pic of arithemetic shifter
plan out the 1 bit ALU section
